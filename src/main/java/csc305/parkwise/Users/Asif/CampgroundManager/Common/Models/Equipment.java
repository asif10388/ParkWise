...
public class Equipment implements Serializable {
    ...
    public Equipment(int itemId, String itemName, String itemType, int itemsInStock, boolean isItemInUse, String itemCategory, int itemPerUnitPrice, String itemDescription, String itemAvailabilityStatus) {
        this.itemId = itemId;
